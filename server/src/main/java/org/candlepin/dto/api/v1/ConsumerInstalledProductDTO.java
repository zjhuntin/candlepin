...
public class ConsumerInstalledProductDTO extends TimestampedCandlepinDTO<ConsumerInstalledProductDTO> {
    ...
    public String toString() {
        ...
        return String.format(
            "ConsumerInstalledProductDTO [id: %s, productId: %s, productName: %s, version: %s, arch: %s, " +
                "status: %s, startDate: %s, endDate: %s]",
            this.getId(), this.getProductId(), this.getProductName(), this.getVersion(), this.getArch(),
            this.getStatus(), this.getStartDate(), this.getEndDate());
    }
    ...
    public ConsumerInstalledProductDTO populate(ConsumerInstalledProductDTO source) {
        ...
        this.setProductId(source.getProductName());
