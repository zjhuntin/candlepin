...
public class ConsumerInstalledProductTranslator extends
     ...
     */
    @Override
    public ConsumerInstalledProductDTO translate(ModelTranslator translator, ConsumerInstalledProduct source) {
     ...
     */
    @Override
    public ConsumerInstalledProductDTO populate(ConsumerInstalledProduct source, ConsumerInstalledProductDTO dest) {
