...
public class GuestIdResource {
    ...
    public GuestIdResource(GuestIdCurator guestIdCurator,
        ...
        I18n i18n, EventFactory eventFactory, EventSink sink, ModelTranslator translator) {
    ...
    public void updateGuest(
        ...
        @PathParam("guest_id") String guestId,
        @ApiParam(name = "updated", required = true, value = "updated guest data to use") GuestIdDTO updatedDTO) {
