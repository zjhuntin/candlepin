...
import static org.candlepin.pki.impl.BouncyCastleProviderLoader.BCFIPS;
...
public class DefaultEntitlementCertServiceAdapterTest {
    ...
    public static void keyPair() throws Exception {
        ...
        try {
            ...
            keyPair = new JcaPEMKeyConverter().setProvider(BCFIPS).getKeyPair((PEMKeyPair) reader.readObject
                ());
        }
        finally {
            if (reader != null) {
